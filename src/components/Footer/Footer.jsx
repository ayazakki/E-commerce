...
export default function Footer() {
  return <>
    <div className='bg-neutral-100 mt-16 py-8 px-9'>
      <h4 className='text-2xl text-gray-600'>Get the FreshCart app</h4>
      ...
      <span className='text-neutral-600 me-3'>Payment partners:</span>
      ...
      <div className='flex sm:items-center flex-col sm:flex-row'>
        <span className='text-neutral-600 me-3 mb-4 sm:mb-0 '>Get deliveries with FreshCard:</span>
        <div>
