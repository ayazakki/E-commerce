...
export default function VerifyResetCode() {
  ...
  return <>
    <div className="container mt-32 pt-14 h-screen">
        <h1 className='mb-3.5 dark:text-gray-50'>Please enter your reset code:</h1>
      ...
      name='resetCode'
      type="text" id="text" className="mb-3.5 outline-0 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-50 dark:text-white" />
